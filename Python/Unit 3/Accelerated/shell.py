...
# When you run these lines, the output should be EXACTLY this (though it's ok if the last decimal digit is different):
# 0.04322254896521112
# 5.58654615850299
# 6
#
...
# Once you have cracked all 3 messages, delete all your test code - just leave the global variables & def blocks!
